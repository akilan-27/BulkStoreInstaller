      ...
      <DialogContent className="sm:max-w-md bg-background/95 backdrop-blur-3xl border-border/50">
        ...
        <DialogFooter className="flex-col gap-2 sm:flex-col">
          <Button
            ...
            render={<a href="https://github.com/akilan-27/BulkStoreInstaller/releases/latest/download/BulkStoreInstallerCompanionSetup.exe" target="_blank" rel="noopener noreferrer" />}
            nativeButton={false}
          >
